...
void main() {
  final instance = SeerrDart().getSettingsApi();
  ...
  group(SettingsApi, () {
    ...
    //
    //Future<BlacklistGet200Response> blacklistGet({ num take, num skip, String search, String filter }) async
    ...
    //
    //Future<MainSettings> settingsNetworkGet() async
    test('test settingsNetworkGet', () async {
      // TODO
    });
    ...
    //
    //Future<NetworkSettings> settingsNetworkPost(NetworkSettings networkSettings) async
    test('test settingsNetworkPost', () async {
      // TODO
    });
    ...
    //
    //Future<NtfySettings> settingsNotificationsNtfyGet() async
    test('test settingsNotificationsNtfyGet', () async {
      // TODO
    });
    ...
    //
    //Future<NtfySettings> settingsNotificationsNtfyPost(NtfySettings ntfySettings) async
    test('test settingsNotificationsNtfyPost', () async {
      // TODO
    });
    ...
    //
    //Future settingsNotificationsNtfyTestPost(NtfySettings ntfySettings) async
    test('test settingsNotificationsNtfyTestPost', () async {
      // TODO
    });

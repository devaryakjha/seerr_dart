...
void main() {
  final instance = SeerrDart().getRequestApi();
  ...
  group(RequestApi, () {
    ...
    //
    //Future<UserUserIdRequestsGet200Response> requestGet({ num take, num skip, String filter, String sort, String sortDirection, num requestedBy, String mediaType }) async

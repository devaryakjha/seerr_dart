...
/// tests for UsersApi
void main() {
  final instance = SeerrDart().getUsersApi();
  ...
  group(UsersApi, () {
    ...
    //
    //Future<UserGet200Response> userGet({ num take, num skip, String sort, String q, String includeIds }) async
    ...
    //
    //Future userUserIdSettingsLinkedAccountsJellyfinDelete(num userId) async
    test('test userUserIdSettingsLinkedAccountsJellyfinDelete', () async {
      // TODO
    });
    ...
    //
    //Future userUserIdSettingsLinkedAccountsJellyfinPost(num userId, UserUserIdSettingsLinkedAccountsJellyfinPostRequest userUserIdSettingsLinkedAccountsJellyfinPostRequest) async
    test('test userUserIdSettingsLinkedAccountsJellyfinPost', () async {
      // TODO
    });
    ...
    //
    //Future userUserIdSettingsLinkedAccountsPlexDelete(num userId) async
    test('test userUserIdSettingsLinkedAccountsPlexDelete', () async {
      // TODO
    });
    ...
    //
    //Future userUserIdSettingsLinkedAccountsPlexPost(num userId, AuthPlexPostRequest authPlexPostRequest) async
    test('test userUserIdSettingsLinkedAccountsPlexPost', () async {
      // TODO
    });
    ...
    //
    //Future<UserSettings> userUserIdSettingsMainGet(num userId) async
    ...
    //
    //Future<UserSettings> userUserIdSettingsMainPost(num userId, UserSettings userSettings) async

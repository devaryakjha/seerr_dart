...
/// tests for SearchApi
void main() {
  final instance = SeerrDart().getSearchApi();
  ...
  group(SearchApi, () {
    ...
    //
    //Future<DiscoverMoviesGet200Response> discoverMoviesGet({ num page, String language, String genre, num studio, String keywords, String sortBy, String primaryReleaseDateGte, String primaryReleaseDateLte, num withRuntimeGte, num withRuntimeLte, num voteAverageGte, num voteAverageLte, num voteCountGte, num voteCountLte, String watchRegion, String watchProviders, String certification, String certificationGte, String certificationLte, String certificationCountry, String certificationMode }) async
    ...
    //
    //Future<DiscoverTvGet200Response> discoverTvGet({ num page, String language, String genre, num network, String keywords, String sortBy, String firstAirDateGte, String firstAirDateLte, num withRuntimeGte, num withRuntimeLte, num voteAverageGte, num voteAverageLte, num voteCountGte, num voteCountLte, String watchRegion, String watchProviders, String status, String certification, String certificationGte, String certificationLte, String certificationCountry, String certificationMode }) async

...
import 'package:seerr_dart/src/serializers.dart';
import 'package:seerr_dart/src/auth/api_key_auth.dart';
import 'package:seerr_dart/src/auth/basic_auth.dart';
import 'package:seerr_dart/src/auth/bearer_auth.dart';
import 'package:seerr_dart/src/auth/oauth.dart';
import 'package:seerr_dart/src/api/auth_api.dart';
import 'package:seerr_dart/src/api/blacklist_api.dart';
import 'package:seerr_dart/src/api/collection_api.dart';
import 'package:seerr_dart/src/api/issue_api.dart';
import 'package:seerr_dart/src/api/media_api.dart';
import 'package:seerr_dart/src/api/movies_api.dart';
import 'package:seerr_dart/src/api/other_api.dart';
import 'package:seerr_dart/src/api/overriderule_api.dart';
import 'package:seerr_dart/src/api/person_api.dart';
import 'package:seerr_dart/src/api/public_api.dart';
import 'package:seerr_dart/src/api/request_api.dart';
import 'package:seerr_dart/src/api/search_api.dart';
import 'package:seerr_dart/src/api/service_api.dart';
import 'package:seerr_dart/src/api/settings_api.dart';
import 'package:seerr_dart/src/api/tmdb_api.dart';
import 'package:seerr_dart/src/api/tv_api.dart';
import 'package:seerr_dart/src/api/users_api.dart';
import 'package:seerr_dart/src/api/watchlist_api.dart';
...
class SeerrDart {
  ...
  /// Get BlacklistApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BlacklistApi getBlacklistApi() {
    return BlacklistApi(dio, serializers);
  }
  ...
  /// Get OverrideruleApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  OverrideruleApi getOverrideruleApi() {
    return OverrideruleApi(dio, serializers);
  }

...
import 'package:seerr_dart/src/model/blacklist.dart';
...
class BlacklistApi {
  ...
  const BlacklistApi(this._dio, this._serializers);
  ...
  Future<Response<void>> blacklistPost({
    ...
    try {
      const _type = FullType(Blacklist);
      _bodyData = _serializers.serialize(blacklist, specifiedType: _type);

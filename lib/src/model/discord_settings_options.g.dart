...
class _$DiscordSettingsOptions extends DiscordSettingsOptions {
  ...
  bool operator ==(Object other) {
    ...
    return other is DiscordSettingsOptions &&
        ...
        webhookRoleId == other.webhookRoleId &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, webhookRoleId.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'DiscordSettingsOptions')
          ...
          ..add('webhookRoleId', webhookRoleId)
...
class DiscordSettingsOptionsBuilder
  ...
  String? _webhookRoleId;
  String? get webhookRoleId => _$this._webhookRoleId;
  set webhookRoleId(String? webhookRoleId) =>
      _$this._webhookRoleId = webhookRoleId;
  ...
  DiscordSettingsOptionsBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _webhookRoleId = $v.webhookRoleId;

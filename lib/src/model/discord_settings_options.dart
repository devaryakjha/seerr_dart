...
abstract class DiscordSettingsOptions
  ...
  @BuiltValueField(wireName: r'webhookRoleId')
  String? get webhookRoleId;
...
class _$DiscordSettingsOptionsSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.webhookRoleId != null) {
      yield r'webhookRoleId';
      yield serializers.serialize(
        object.webhookRoleId,
        specifiedType: const FullType(String),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'webhookUrl':
          ...
          break;
        case r'webhookRoleId':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(String),
          ) as String;
          result.webhookRoleId = valueDes;
          break;

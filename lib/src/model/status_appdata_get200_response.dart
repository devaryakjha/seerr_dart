...
abstract class StatusAppdataGet200Response
  ...
  @BuiltValueField(wireName: r'appDataPermissions')
  bool? get appDataPermissions;
...
class _$StatusAppdataGet200ResponseSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.appDataPermissions != null) {
      yield r'appDataPermissions';
      yield serializers.serialize(
        object.appDataPermissions,
        specifiedType: const FullType(bool),
      );
    }
  }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'appDataPath':
          ...
          break;
        case r'appDataPermissions':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.appDataPermissions = valueDes;
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);

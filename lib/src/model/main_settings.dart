...
abstract class MainSettings
  ...
  @BuiltValueField(wireName: r'enableSpecialEpisodes')
  bool? get enableSpecialEpisodes;
...
class _$MainSettingsSerializer implements PrimitiveSerializer<MainSettings> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.enableSpecialEpisodes != null) {
      yield r'enableSpecialEpisodes';
      yield serializers.serialize(
        object.enableSpecialEpisodes,
        specifiedType: const FullType(bool),
      );
    }
  }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'defaultPermissions':
          ...
          break;
        case r'enableSpecialEpisodes':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(bool),
          ) as bool;
          result.enableSpecialEpisodes = valueDes;
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);

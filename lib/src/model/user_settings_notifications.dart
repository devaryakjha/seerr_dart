...
import 'package:seerr_dart/src/model/notification_agent_types.dart';
...
abstract class UserSettingsNotifications
  ...
  @BuiltValueField(wireName: r'telegramMessageThreadId')
  String? get telegramMessageThreadId;
...
class _$UserSettingsNotificationsSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.telegramMessageThreadId != null) {
      yield r'telegramMessageThreadId';
      yield serializers.serialize(
        object.telegramMessageThreadId,
        specifiedType: const FullType.nullable(String),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'telegramChatId':
          ...
          break;
        case r'telegramMessageThreadId':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(String),
          ) as String?;
          if (valueDes == null) continue;
          result.telegramMessageThreadId = valueDes;
          break;

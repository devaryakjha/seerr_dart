...
class _$UserSettingsNotifications extends UserSettingsNotifications {
  ...
  bool operator ==(Object other) {
    ...
    return other is UserSettingsNotifications &&
        ...
        telegramMessageThreadId == other.telegramMessageThreadId &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, telegramMessageThreadId.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UserSettingsNotifications')
          ...
          ..add('telegramMessageThreadId', telegramMessageThreadId)
...
class UserSettingsNotificationsBuilder
  ...
  String? _telegramMessageThreadId;
  String? get telegramMessageThreadId => _$this._telegramMessageThreadId;
  set telegramMessageThreadId(String? telegramMessageThreadId) =>
      _$this._telegramMessageThreadId = telegramMessageThreadId;
  ...
  UserSettingsNotificationsBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _telegramMessageThreadId = $v.telegramMessageThreadId;
